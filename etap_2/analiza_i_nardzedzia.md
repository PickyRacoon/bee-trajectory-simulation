...
W ostatnich latach rozwinięto systemy umożliwiające automatyczne monitorowanie aktywności pszczół przy wejściu do ula z wykorzystaniem kamer oraz specjalnych znaczników (np. **AprilTags**). Systemy tego typu pozwalają na rejestrowanie danych takich jak:
